...
type fwdconn struct {
	...
	// mu protects fields that follow it; it is is also change's Locker
	mu sync.Mutex
...
// send sends packet to dst using fwdconn's connection.
...
// read waits for a response from fwdconn's connection.
