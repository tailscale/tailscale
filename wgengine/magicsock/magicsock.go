...
type Conn struct {
	...
	// webrtcMgr manages WebRTC connections for peers. It is nil if the
	// ts_omit_webrtc build tag is set, if feature/webrtc was not linked in
	// (e.g. a tsnet build that doesn't import it), or if WebRTC failed to
	// initialize.
