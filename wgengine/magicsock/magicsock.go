...
func NewConn(opts Options) (*Conn, error) {
	...
	if debugAlwaysWebRTC() && debugAlwaysDERP() {
		c.logf("magicsock: WARNING: both TS_DEBUG_ALWAYS_USE_WEBRTC and TS_DEBUG_ALWAYS_USE_DERP are set; they are mutually exclusive, DERP wins")
	}
