...
func NewUserspaceEngine(logf logger.Logf, conf Config) (_ Engine, reterr error) {
	...
	e.tundev.PreFilterPacketInboundFromWireGuard = e.handleTunnelPackets

	// TODO: need to integrate this hook with app connector hook
...
func (e *userspaceEngine) handleLocalPackets(p *packet.Parsed, t *tstun.Wrapper) filter.Response {
	...
	if e.appConnectorPacketHooks != nil {
...
func (e *userspaceEngine) handleTunnelPackets(p *packet.Parsed, t *tstun.Wrapper) filter.Response {
	if e.appConnectorPacketHooks != nil {
