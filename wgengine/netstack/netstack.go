...
type Impl struct {
	...
	dns            *dns.Manager
	tailFSForLocal taildrive.FileSystemForLocal // or nil
...
func Create(logf logger.Logf, tundev *tstun.Wrapper, e wgengine.Engine, mc *magicsock.Conn, dialer *tsdial.Dialer, dns *dns.Manager, pm *proxymap.Mapper, tailFSForLocal taildrive.FileSystemForLocal) (*Impl, error) {
	if mc == nil {
