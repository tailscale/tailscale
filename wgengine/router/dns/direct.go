...
// regardless of whether it is managing the system DNS settings.
...
func newDirectManager(mconfig ManagerConfig) managerImpl {
	tellResolved := isResolvedRunning()
	return &directManager{
		tellResolved: tellResolved,
	}
}
...
func (m *directManager) Up(config Config) error {
	...
	if m.tellResolved {
		exec.Command("systemctl", "restart", "systemd-resolved").Run() // Best-effort.
	}
