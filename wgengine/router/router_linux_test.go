...
func TestRouterStates(t *testing.T) {
	states := []struct {
	...
	}{
		{
			...
			want: `
up
fwmark 0x20000/0x20000 priority 10000 table main suppress_ifgroup 10000
`,
		},
		{
			...
			want: `
up
100.101.102.103/10 dev tailscale0
fwmark 0x20000/0x20000 priority 10000 table main suppress_ifgroup 10000
`,
		},
...
up
100.101.102.103/10 dev tailscale0
100.100.100.100/32 dev tailscale0 scope global
192.168.16.0/24 dev tailscale0 scope global
fwmark 0x20000/0x20000 priority 10000 table main suppress_ifgroup 10000
`,
		},
...
`,
...

		{
			...
			want: `
up
100.101.102.104/10 dev tailscale0
10.0.0.0/8 dev tailscale0 scope global
100.100.100.100/32 dev tailscale0 scope global
fwmark 0x20000/0x20000 priority 10000 table main suppress_ifgroup 10000
