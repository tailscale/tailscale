...
type Detector struct {
	// mu is a mutex used to protect httpClient and currIfIndex from concurrent access.
	// It is needed because we issue requests concurrently to different endpoints, using
	// a shared httpClient.
	mu sync.Mutex
