...
// Least-recently-used eviction keeps each direction's buffer bounded.
//
...
const (
	...
	ReasonAppConnectorTransitIPUnknown Reason = "app-connector-transit-ip-unknown"
...
type DebugRejectsResponse struct {
	// Enabled is whether [nodecap.ConnReject] is currently set
