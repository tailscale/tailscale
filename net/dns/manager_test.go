...
func TestManager(t *testing.T) {
	...
	tests := []struct {
		...
		{
			// On iOS, even trivial "default resolvers only" configs should
			// route through quad-100 so the Go forwarder handles multi-server
			// fallback instead of relying on iOS's NEDNSSettings.
