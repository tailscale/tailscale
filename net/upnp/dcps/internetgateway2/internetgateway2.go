...
func (client *DeviceProtection1) SendSetupMessage(ctx context.Context, ProtocolType string, InMessage []byte) (OutMessage []byte, err error) {
	// Request structure.
	request := &struct {
		ProtocolType string
		InMessage    string
...
func (client *DeviceProtection1) GetSupportedProtocols(ctx context.Context) (ProtocolList string, err error) {
	// Request structure.
...
func (client *DeviceProtection1) GetAssignedRoles(ctx context.Context) (RoleList string, err error) {
	// Request structure.
	request := interface{}(nil)
	// BEGIN Marshal arguments into request.
...
func (client *DeviceProtection1) GetRolesForAction(ctx context.Context, DeviceUDN string, ServiceId string, ActionName string) (RoleList string, RestrictedRoleList string, err error) {
	// Request structure.
	request := &struct {
		DeviceUDN  string
		ServiceId  string
...
func (client *DeviceProtection1) GetUserLoginChallenge(ctx context.Context, ProtocolType string, Name string) (Salt []byte, Challenge []byte, err error) {
	// Request structure.
	request := &struct {
		ProtocolType string
		Name         string
...
func (client *DeviceProtection1) UserLogin(ctx context.Context, ProtocolType string, Challenge []byte, Authenticator []byte) (err error) {
	// Request structure.
	request := &struct {
		ProtocolType  string
		Challenge     string
...
func (client *DeviceProtection1) UserLogout(ctx context.Context) (err error) {
	// Request structure.
	request := interface{}(nil)
	// BEGIN Marshal arguments into request.
...
func (client *DeviceProtection1) GetACLData(ctx context.Context) (ACL string, err error) {
	// Request structure.
	request := interface{}(nil)
	// BEGIN Marshal arguments into request.
...
func (client *DeviceProtection1) AddIdentityList(ctx context.Context, IdentityList string) (IdentityListResult string, err error) {
	// Request structure.
	request := &struct {
		IdentityList string
	}{}
...
func (client *DeviceProtection1) RemoveIdentity(ctx context.Context, Identity string) (err error) {
	// Request structure.
	request := &struct {
		Identity string
	}{}
...
func (client *DeviceProtection1) SetUserLoginPassword(ctx context.Context, ProtocolType string, Name string, Stored []byte, Salt []byte) (err error) {
	// Request structure.
	request := &struct {
		ProtocolType string
		Name         string
...
func (client *DeviceProtection1) AddRolesForIdentity(ctx context.Context, Identity string, RoleList string) (err error) {
	// Request structure.
	request := &struct {
		Identity string
		RoleList string
...
func (client *DeviceProtection1) RemoveRolesForIdentity(ctx context.Context, Identity string, RoleList string) (err error) {
	// Request structure.
	request := &struct {
		Identity string
		RoleList string
...
func (client *LANHostConfigManagement1) SetDHCPServerConfigurable(ctx context.Context, NewDHCPServerConfigurable bool) (err error) {
	// Request structure.
	request := &struct {
...
func (client *LANHostConfigManagement1) GetDHCPServerConfigurable(ctx context.Context) (NewDHCPServerConfigurable bool, err error) {
	// Request structure.
	request := interface{}(nil)
	// BEGIN Marshal arguments into request.
...
func (client *LANHostConfigManagement1) SetDHCPRelay(ctx context.Context, NewDHCPRelay bool) (err error) {
	// Request structure.
	request := &struct {
		NewDHCPRelay string
	}{}
...
func (client *LANHostConfigManagement1) GetDHCPRelay(ctx context.Context) (NewDHCPRelay bool, err error) {
	// Request structure.
	request := interface{}(nil)
	// BEGIN Marshal arguments into request.
...
func (client *LANHostConfigManagement1) SetSubnetMask(ctx context.Context, NewSubnetMask string) (err error) {
	// Request structure.
	request := &struct {
...
func (client *LANHostConfigManagement1) GetSubnetMask(ctx context.Context) (NewSubnetMask string, err error) {
	// Request structure.
	request := interface{}(nil)
	// BEGIN Marshal arguments into request.
...
func (client *LANHostConfigManagement1) SetIPRouter(ctx context.Context, NewIPRouters string) (err error) {
	// Request structure.
	request := &struct {
		NewIPRouters string
	}{}
...
func (client *LANHostConfigManagement1) DeleteIPRouter(ctx context.Context, NewIPRouters string) (err error) {
	// Request structure.
	request := &struct {
		NewIPRouters string
	}{}
...
func (client *LANHostConfigManagement1) GetIPRoutersList(ctx context.Context) (NewIPRouters string, err error) {
	// Request structure.
	request := interface{}(nil)
	// BEGIN Marshal arguments into request.
...
func (client *LANHostConfigManagement1) SetDomainName(ctx context.Context, NewDomainName string) (err error) {
	// Request structure.
	request := &struct {
...
func (client *LANHostConfigManagement1) GetDomainName(ctx context.Context) (NewDomainName string, err error) {
	// Request structure.
	request := interface{}(nil)
	// BEGIN Marshal arguments into request.
...
func (client *LANHostConfigManagement1) SetAddressRange(ctx context.Context, NewMinAddress string, NewMaxAddress string) (err error) {
	// Request structure.
	request := &struct {
...
func (client *LANHostConfigManagement1) GetAddressRange(ctx context.Context) (NewMinAddress string, NewMaxAddress string, err error) {
	// Request structure.
	request := interface{}(nil)
	// BEGIN Marshal arguments into request.
...
func (client *LANHostConfigManagement1) SetReservedAddress(ctx context.Context, NewReservedAddresses string) (err error) {
	// Request structure.
	request := &struct {
...
func (client *LANHostConfigManagement1) DeleteReservedAddress(ctx context.Context, NewReservedAddresses string) (err error) {
	// Request structure.
	request := &struct {
		NewReservedAddresses string
	}{}
...
func (client *LANHostConfigManagement1) GetReservedAddresses(ctx context.Context) (NewReservedAddresses string, err error) {
	// Request structure.
	request := interface{}(nil)
	// BEGIN Marshal arguments into request.
...
func (client *LANHostConfigManagement1) SetDNSServer(ctx context.Context, NewDNSServers string) (err error) {
	// Request structure.
	request := &struct {
...
func (client *LANHostConfigManagement1) DeleteDNSServer(ctx context.Context, NewDNSServers string) (err error) {
	// Request structure.
	request := &struct {
		NewDNSServers string
	}{}
...
func (client *LANHostConfigManagement1) GetDNSServers(ctx context.Context) (NewDNSServers string, err error) {
	// Request structure.
	request := interface{}(nil)
	// BEGIN Marshal arguments into request.
...
func (client *Layer3Forwarding1) SetDefaultConnectionService(ctx context.Context, NewDefaultConnectionService string) (err error) {
	// Request structure.
	request := &struct {
...
func (client *Layer3Forwarding1) GetDefaultConnectionService(ctx context.Context) (NewDefaultConnectionService string, err error) {
	// Request structure.
	request := interface{}(nil)
	// BEGIN Marshal arguments into request.
...
func (client *WANCableLinkConfig1) GetCableLinkConfigInfo(ctx context.Context) (NewCableLinkConfigState string, NewLinkType string, err error) {
	// Request structure.
	request := interface{}(nil)
	// BEGIN Marshal arguments into request.
...
func (client *WANCableLinkConfig1) GetDownstreamFrequency(ctx context.Context) (NewDownstreamFrequency uint32, err error) {
	// Request structure.
	request := interface{}(nil)
	// BEGIN Marshal arguments into request.
...
func (client *WANCableLinkConfig1) GetDownstreamModulation(ctx context.Context) (NewDownstreamModulation string, err error) {
	// Request structure.
	request := interface{}(nil)
	// BEGIN Marshal arguments into request.
...
func (client *WANCableLinkConfig1) GetUpstreamFrequency(ctx context.Context) (NewUpstreamFrequency uint32, err error) {
	// Request structure.
	request := interface{}(nil)
	// BEGIN Marshal arguments into request.
...
func (client *WANCableLinkConfig1) GetUpstreamModulation(ctx context.Context) (NewUpstreamModulation string, err error) {
	// Request structure.
	request := interface{}(nil)
	// BEGIN Marshal arguments into request.
...
func (client *WANCableLinkConfig1) GetUpstreamChannelID(ctx context.Context) (NewUpstreamChannelID uint32, err error) {
	// Request structure.
	request := interface{}(nil)
	// BEGIN Marshal arguments into request.
...
func (client *WANCableLinkConfig1) GetUpstreamPowerLevel(ctx context.Context) (NewUpstreamPowerLevel uint32, err error) {
	// Request structure.
	request := interface{}(nil)
	// BEGIN Marshal arguments into request.
...
func (client *WANCableLinkConfig1) GetBPIEncryptionEnabled(ctx context.Context) (NewBPIEncryptionEnabled bool, err error) {
	// Request structure.
	request := interface{}(nil)
	// BEGIN Marshal arguments into request.
...
func (client *WANCableLinkConfig1) GetConfigFile(ctx context.Context) (NewConfigFile string, err error) {
	// Request structure.
	request := interface{}(nil)
	// BEGIN Marshal arguments into request.
...
func (client *WANCableLinkConfig1) GetTFTPServer(ctx context.Context) (NewTFTPServer string, err error) {
	// Request structure.
	request := interface{}(nil)
	// BEGIN Marshal arguments into request.
...
func (client *WANCommonInterfaceConfig1) SetEnabledForInternet(ctx context.Context, NewEnabledForInternet bool) (err error) {
	// Request structure.
	request := &struct {
...
func (client *WANCommonInterfaceConfig1) GetEnabledForInternet(ctx context.Context) (NewEnabledForInternet bool, err error) {
	// Request structure.
	request := interface{}(nil)
	// BEGIN Marshal arguments into request.
...
func (client *WANCommonInterfaceConfig1) GetCommonLinkProperties(ctx context.Context) (NewWANAccessType string, NewLayer1UpstreamMaxBitRate uint32, NewLayer1DownstreamMaxBitRate uint32, NewPhysicalLinkStatus string, err error) {
	// Request structure.
	request := interface{}(nil)
	// BEGIN Marshal arguments into request.
...
func (client *WANCommonInterfaceConfig1) GetWANAccessProvider(ctx context.Context) (NewWANAccessProvider string, err error) {
	// Request structure.
	request := interface{}(nil)
	// BEGIN Marshal arguments into request.
...
func (client *WANCommonInterfaceConfig1) GetMaximumActiveConnections(ctx context.Context) (NewMaximumActiveConnections uint16, err error) {
	// Request structure.
	request := interface{}(nil)
	// BEGIN Marshal arguments into request.
...
func (client *WANCommonInterfaceConfig1) GetTotalBytesSent(ctx context.Context) (NewTotalBytesSent uint64, err error) {
	// Request structure.
	request := interface{}(nil)
	// BEGIN Marshal arguments into request.
...
func (client *WANCommonInterfaceConfig1) GetTotalBytesReceived(ctx context.Context) (NewTotalBytesReceived uint64, err error) {
	// Request structure.
	request := interface{}(nil)
	// BEGIN Marshal arguments into request.
...
func (client *WANCommonInterfaceConfig1) GetTotalPacketsSent(ctx context.Context) (NewTotalPacketsSent uint32, err error) {
	// Request structure.
	request := interface{}(nil)
	// BEGIN Marshal arguments into request.
...
func (client *WANCommonInterfaceConfig1) GetTotalPacketsReceived(ctx context.Context) (NewTotalPacketsReceived uint32, err error) {
	// Request structure.
	request := interface{}(nil)
	// BEGIN Marshal arguments into request.
...
func (client *WANCommonInterfaceConfig1) GetActiveConnection(ctx context.Context, NewActiveConnectionIndex uint16) (NewActiveConnDeviceContainer string, NewActiveConnectionServiceID string, err error) {
	// Request structure.
	request := &struct {
...
func (client *WANDSLLinkConfig1) SetDSLLinkType(ctx context.Context, NewLinkType string) (err error) {
	// Request structure.
	request := &struct {
		NewLinkType string
	}{}
...
func (client *WANDSLLinkConfig1) GetDSLLinkInfo(ctx context.Context) (NewLinkType string, NewLinkStatus string, err error) {
	// Request structure.
	request := interface{}(nil)
	// BEGIN Marshal arguments into request.
...
func (client *WANDSLLinkConfig1) GetAutoConfig(ctx context.Context) (NewAutoConfig bool, err error) {
	// Request structure.
	request := interface{}(nil)
	// BEGIN Marshal arguments into request.
...
func (client *WANDSLLinkConfig1) GetModulationType(ctx context.Context) (NewModulationType string, err error) {
	// Request structure.
	request := interface{}(nil)
	// BEGIN Marshal arguments into request.
...
func (client *WANDSLLinkConfig1) SetDestinationAddress(ctx context.Context, NewDestinationAddress string) (err error) {
	// Request structure.
	request := &struct {
...
func (client *WANDSLLinkConfig1) GetDestinationAddress(ctx context.Context) (NewDestinationAddress string, err error) {
	// Request structure.
	request := interface{}(nil)
	// BEGIN Marshal arguments into request.
...
func (client *WANDSLLinkConfig1) SetATMEncapsulation(ctx context.Context, NewATMEncapsulation string) (err error) {
	// Request structure.
	request := &struct {
...
func (client *WANDSLLinkConfig1) GetATMEncapsulation(ctx context.Context) (NewATMEncapsulation string, err error) {
	// Request structure.
	request := interface{}(nil)
	// BEGIN Marshal arguments into request.
...
func (client *WANDSLLinkConfig1) SetFCSPreserved(ctx context.Context, NewFCSPreserved bool) (err error) {
	// Request structure.
	request := &struct {
...
func (client *WANDSLLinkConfig1) GetFCSPreserved(ctx context.Context) (NewFCSPreserved bool, err error) {
	// Request structure.
	request := interface{}(nil)
	// BEGIN Marshal arguments into request.
...
func (client *WANEthernetLinkConfig1) GetEthernetLinkStatus(ctx context.Context) (NewEthernetLinkStatus string, err error) {
	// Request structure.
	request := interface{}(nil)
	// BEGIN Marshal arguments into request.
