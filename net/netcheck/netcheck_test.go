...
func TestLogConciseReport(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			name: "no_udp",
			r:    &Report{},
			want: "udp=false v4=false v6=false mapvarydest= hair= portmap=na derp=0",
		},
		{
			...
			want: "udp=true v6=false mapvarydest= hair= portmap=na derp=1 derpdist=1v4:10ms",
		},
		{
			...
			want: "udp=true v6=false mapvarydest= hair= portmap=na derp=1 derpdist=1v4:10ms,2v4:20ms,3v4:30ms",
		},
		{
			...
			want: "udp=true v6=true mapvarydest= hair= portmap=na derp=1 derpdist=1v4:10ms,1v6:10ms,2v4:20ms,2v6:20ms,3v4:30ms,3v6:30ms",
		},
		{
			name: "portmap_all",
			r: &Report{
