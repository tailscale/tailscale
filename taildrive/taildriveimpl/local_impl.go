...
// Package taildriveimpl provides an implementation of package taildrive.
...
func (s *FileSystemForLocal) SetRemotes(domain string, remotes []*taildrive.Remote, transport http.RoundTripper) {
