...
// version, use the versionId subresource. If your bucket uses the bucket owner
// enforced setting for S3 Object Ownership, requests to read ACLs are still
// supported and return the bucket-owner-full-control ACL with the owner being the
// account that created the bucket. For more information, see  Controlling object
