...
func (Std) ContextWithTimeout(ctx context.Context, d time.Duration) (context.Context, context.CancelFunc) {
	return context.WithTimeout(ctx, d)
}

// ContextWithDeadline is like context.WithDeadline.
func (Std) ContextWithDeadline(ctx context.Context, t time.Time) (context.Context, context.CancelFunc) {
...
// ContextWithTimeout is like context.WithTimeout.
func (vt *Virtual) ContextWithTimeout(ctx context.Context, d time.Duration) (context.Context, context.CancelFunc) {
	ctx, cancel := context.WithTimeout(ctx, vt.virtualToWallDuration(d))
	return virtualContext{ctx, vt}, cancel
}

// ContextWithDeadline is like context.WithDeadline.
func (vt *Virtual) ContextWithDeadline(ctx context.Context, t time.Time) (context.Context, context.CancelFunc) {
