...
func TestNewJSONHandler(t *testing.T) {
	...
	h21 := JSONHandler(func(r *http.Request) (int, interface{}, error) {
	...
	t.Run("403 HTTPError", func(t *testing.T) {
		h := JSONHandler(func(r *http.Request) (int, interface{}, error) {
	...
	h22 := JSONHandler(func(r *http.Request) (int, interface{}, error) {
	...
	h31 := JSONHandler(func(r *http.Request) (int, interface{}, error) {
		body := new(Data)
		...
		if body.Name == "" {
			return http.StatusBadRequest, nil, fmt.Errorf("name is empty")
		}
	...
	h32 := JSONHandler(func(r *http.Request) (int, interface{}, error) {
		body := new(Data)
		if err := json.NewDecoder(r.Body).Decode(body); err != nil {
			return http.StatusBadRequest, nil, err
		}
		if body.Price == 0 {
			return http.StatusBadRequest, nil, fmt.Errorf("price is empty")
		}
	...
	t.Run("500 misuse", func(t *testing.T) {
		...
		JSONHandler(func(r *http.Request) (int, interface{}, error) {
	...
	t.Run("500 empty status code", func(t *testing.T) {
		w := httptest.NewRecorder()
		r := httptest.NewRequest("POST", "/", nil)
		JSONHandler(func(r *http.Request) (status int, data interface{}, err error) {
			return
		}).ServeHTTP(w, r)
