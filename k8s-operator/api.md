...
| `livenessProbe` _[Probe](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.3/#probe-v1-core)_ | Container livenessProbe.<br />By default the operator does not apply any liveness probe. Set the<br />TS_ENABLE_HEALTH_CHECK env var to probe the /healthz endpoint served on<br />TS_LOCAL_ADDR_PORT (9002 by default).<br />https://kubernetes.io/docs/tasks/configure-pod-container/configure-liveness-readiness-startup-probes/ |  |  |
| `readinessProbe` _[Probe](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.3/#probe-v1-core)_ | Container readinessProbe.<br />By default the operator does not apply any readiness probe. Set the<br />TS_ENABLE_HEALTH_CHECK env var to probe the /healthz endpoint served on<br />TS_LOCAL_ADDR_PORT (9002 by default).<br />https://kubernetes.io/docs/tasks/configure-pod-container/configure-liveness-readiness-startup-probes/ |  |  |
