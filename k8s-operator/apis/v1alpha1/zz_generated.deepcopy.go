...
func (in *TailnetDevice) DeepCopyInto(out *TailnetDevice) {
	*out = *in
	...
	if in.TailnetListeners != nil {
		in, out := &in.TailnetListeners, &out.TailnetListeners
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TailnetListener) DeepCopyInto(out *TailnetListener) {
	*out = *in
	if in.Endpoints != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TailnetListener.
func (in *TailnetListener) DeepCopy() *TailnetListener {
	if in == nil {
		return nil
	}
	out := new(TailnetListener)
	in.DeepCopyInto(out)
	return out
}
