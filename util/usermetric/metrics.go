...
const (
	...
	ReasonLinkLocalUnicast DropReason = "link-local-unicast"

	// ReasonBadPacket means that the packet was dropped because it was a bad packet,
	// this could be due to a short package.
	ReasonBadPacket DropReason = "bad-packet"

	// ReasonIPFragment means that the packet was dropped because it was an IP fragment.
	ReasonIPFragment DropReason = "ip-fragment"
