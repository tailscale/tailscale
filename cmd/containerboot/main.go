...
//   - EXPERIMENTAL_WAIT_FOR_TERMINATION: if set to true, the containerboot instance
//     will wait for up to 30 seconds after receiving an interrupt signal. This is
//     primarily useful for subnet routers and app connectors running in a
//     highly available configuration to allow time for connected clients to fail
//     over to the next available instance.
//
