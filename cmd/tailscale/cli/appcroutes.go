...
var appcRoutesCmd = &ffcli.Command{
	...
	FlagSet: (func() *flag.FlagSet {
		...
		fs.BoolVar(&appcRoutesArgs.n, "n", false, "Print the number of routes this node advertises.")
		return fs
	})(),
	LongHelp: strings.TrimSpace(`
The 'tailscale appc-routes' command prints the current App Connector route status.

By default it prints each domain that routes have been learned for, and how many routes have
been learned for that domain.
