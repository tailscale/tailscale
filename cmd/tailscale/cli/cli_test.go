...
func TestCleanUpArgs(t *testing.T) {
	...
	tests := []struct {
		...
		{in: []string{"--authkey=0"}, want: []string{"--authkey=0"}},
		{in: []string{"a", "--authkey=1", "b"}, want: []string{"a", "--authkey=1", "b"}},
		{in: []string{"a", "--auth-key=2", "b"}, want: []string{"a", "--authkey=2", "b"}},
		{in: []string{"a", "-authkey=3", "b"}, want: []string{"a", "--authkey=3", "b"}},
		{in: []string{"a", "-auth-key=4", "b"}, want: []string{"a", "-authkey=4", "b"}},
		{in: []string{"a", "--authkey", "5", "b"}, want: []string{"a", "--authkey", "5", "b"}},
		{in: []string{"a", "-authkey", "6", "b"}, want: []string{"a", "--authkey", "6", "b"}},
