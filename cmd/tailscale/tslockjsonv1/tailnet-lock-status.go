...
func toTailnetLockDisabledStatusV1(status *ipnstate.TailnetLockStatus) StatusResponse {
	out := StatusResponse{
...
func toTailnetLockEnabledStatusV1(status *ipnstate.TailnetLockStatus) StatusResponse {
	out := StatusResponse{
		Enabled: status.Enabled,
	}
