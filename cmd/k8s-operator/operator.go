...
func main() {
	...
	var (
		...
		tsDebugFirewallMode = defaultEnv("PROXY_FIREWALL_MODE", "")
	)
	...
	runReconcilers(zlog, s, tsNamespace, restConfig, tsClient, image, priorityClassName, tags, tsDebugFirewallMode)
}
...
func runReconcilers(zlog *zap.SugaredLogger, s *tsnet.Server, tsNamespace string, restConfig *rest.Config, tsClient *tailscale.Client, image, priorityClassName, tags, firewallMode string) {
	var (
