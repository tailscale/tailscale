...
// indexEgressServices adds a local index to cached Tailscale ingress Services meant to be exposed on a ProxyGroup. The
...
// indexPGIngresses adds a local index to cached Tailscale Ingresses and
