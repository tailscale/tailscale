...
func (esr *egressSvcsReconciler) maybeProvision(ctx context.Context, svc *corev1.Service, l *zap.SugaredLogger) (err error) {
	...
	if clusterIPSvc == nil {
		clusterIPSvc = esr.clusterIPSvcForEgress(crl, svc)
	}
...
func (esr *egressSvcsReconciler) clusterIPSvcForEgress(crl map[string]string, extNameSvc *corev1.Service) *corev1.Service {
