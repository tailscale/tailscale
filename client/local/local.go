...
// GetServicePrefs returns the current [ipn.ServicePrefs] for the current profile.
...
// SetServicePref sets the service prefs for the current profile from an [apitype.ServicePrefRequest].
