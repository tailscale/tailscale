...
func (lc *LocalClient) TailFSShareSet(ctx context.Context, share *taildrive.Share) error {
...
// to remote nodes.
func (lc *LocalClient) TailFSShareList(ctx context.Context) ([]*taildrive.Share, error) {
