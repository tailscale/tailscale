...
func (v PrefsView) TailFSShares() views.SliceView[*taildrive.Share, taildrive.ShareView] {
	return views.SliceOfViews[*taildrive.Share, taildrive.ShareView](v.ж.TailFSShares)
}
