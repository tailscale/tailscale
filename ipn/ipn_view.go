...
//go:generate go run tailscale.com/cmd/cloner  -clonefunc=false -type=Prefs,ServeConfig,ServiceConfig,TCPPortHandler,UDPPortHandler,HTTPHandler,WebServerConfig
