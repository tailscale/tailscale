...
func fakeLocalBackend(t *testing.T, varRoot string, client *http.Client, pm *profileManager, authority *tka.Authority, chonk tka.CompactableChonk) LocalBackend {
...
func TestTKADisablementFlow(t *testing.T) {
	...
	b := fakeLocalBackend(t, varRoot, client, pm, authority, chonk)
...
func TestTKADisable(t *testing.T) {
	...
	b := fakeLocalBackend(t, temp, client, pm, authority, chonk)
