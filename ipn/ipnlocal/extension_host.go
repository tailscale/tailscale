...
type ExtensionHost struct {
	...
	// shutdownCalled is whether [ExtensionHost.Shutdown] has been called.
	shutdownCalled bool
...
func (h *ExtensionHost) init() {
	...
	h.logf("active extensions: %v", strings.Join(slices.Collect(maps.Keys(h.extensionsByName)), ", "))
