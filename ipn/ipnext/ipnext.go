...
// Make instantiates the extension.
func (d *Definition) Make(logf logger.Logf, sys *tsd.System) (Extension, error) {
...
// whose [Definition.Make] method returns the specified error.
