...
func getTickCount64() (res uint64) {
...
func peekMessage(lpMsg *_MSG, hwnd windows.HWND, msgMin uint32, msgMax uint32, remove uint32) (ret bool) {
	r0, _, _ := syscall.Syscall6(procPeekMessageW.Addr(), 5, uintptr(unsafe.Pointer(lpMsg)), uintptr(hwnd), uintptr(msgMin), uintptr(msgMax), uintptr(remove), 0)
	ret = r0 != 0
	return
}
