...
// When the mapSession is closed, the remaining queue is processed before the
// processing stops.
...
func (ms *mapSession) updateDiscoForNode(id tailcfg.NodeID, key key.DiscoPublic, lastSeen time.Time, online bool) {
