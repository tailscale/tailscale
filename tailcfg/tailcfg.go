...
const (
	// AuditNodeDisconnect means that a node has disconnected from the control
	// plane at the request of the user.
...
type ClientAuditLog struct {
	...
	// The public node key of the node that generated the audit log.
	NodeKey key.NodePublic `json:",omitempty"`
...
// An audit log request generated by a node
