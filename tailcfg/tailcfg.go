...
type MapResponse struct {
	...
	// PeersChanged are the Nodes (identified by their ID) that changed since the past update on the
	// HTTP response. It's only set if DeltaPeers is sent true.
	...
	// Peers is always returned sorted.
