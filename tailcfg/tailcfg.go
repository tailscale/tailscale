...
type MapRequest struct {
	...
	IncludeIPv6        bool     `json:",omitempty"` // include IPv6 endpoints in returned Node Endpoints
	IncludeIPv6Overlay bool     `json:",omitempty"` // include IPv6 Addresses and AllowedIPs in returned Nodes.
